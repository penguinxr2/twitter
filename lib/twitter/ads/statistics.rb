  ...
  module Ads
    module Statistics
      ...
      def account_stats(account_id, options = {})
        perform_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}", options)
      end
      ...
      def campaign_stats(account_id, campaign_id, options = {})
        perform_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}/campaigns/#{campaign_id}", options)
      end
      ...
      def line_item_stats(account_id, line_item_id, options = {})
        perform_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}/line_items/#{line_item_id}", options)
      end
      ...
      def promoted_tweet_stats(account_id, promoted_tweet_id, options = {})
        perform_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}/promoted_tweets/#{promoted_tweet_id}", options)
      end
      ...
      def promoted_account_stats(account_id, promoted_account_id, options = {})
        perform_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}/promoted_accounts/#{promoted_account_id}", options)
      end
      ...
      def funding_instrument_stats(account_id, funding_instrument_id, options = {})
        perform_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}/funding_instruments/#{funding_instrument_id}", options)
      end
      ...
      def campaigns_stats(account_id, campaign_ids, options = {})
        perform_collection_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}/campaigns",
      ...
      def line_items_stats(account_id, line_item_ids, options = {})
        perform_collection_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}/line_items",
      ...
      def promoted_tweets_stats(account_id, promoted_tweet_ids, options = {})
        perform_collection_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}/promoted_tweets",
      ...
      def promoted_accounts_stats(account_id, promoted_account_ids, options = {})
        perform_collection_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}/promoted_accounts",
      ...
      def funding_instruments_stats(account_id, funding_instrument_ids, options = {})
        perform_collection_get_for_stats("https://ads-api.twitter.com/1/stats/accounts/#{account_id}/funding_instruments",
