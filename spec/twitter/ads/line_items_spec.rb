...
describe Twitter::Ads::LineItems do
  ...
  describe '#line_items' do
    before do
      stub_get('https://ads-api.twitter.com/1/accounts/hkk5/line_items').to_return(body: fixture('line_items.json'), headers:{content_type: 'application/json; charset=utf-8'})
    end
    it 'requests resources' do
      @client.line_items(account_id)
      expect(a_get('https://ads-api.twitter.com/1/accounts/hkk5/line_items')).to have_been_made
    end
  ...
  describe '#line_item' do
    before do
      stub_get('https://ads-api.twitter.com/1/accounts/hkk5/line_items/69ob').to_return(body: fixture('line_item.json'), headers:{content_type: 'application/json; charset=utf-8'})
    end
    it 'requests resources' do
      @client.line_item(account_id, '69ob')
      expect(a_get('https://ads-api.twitter.com/1/accounts/hkk5/line_items/69ob')).to have_been_made
    end
    it 'gets the right resources' do
  ...
  describe '#create_line_item' do
    ...
    before do
      stub_post('https://ads-api.twitter.com/1/accounts/hkk5/line_items')
  ...
  describe '#update_line_item' do
    ...
    before do
      stub_put('https://ads-api.twitter.com/1/accounts/hkk5/line_items/6zva')
    ...
    it 'updates a line item' do
      ...
      expect(a_put('https://ads-api.twitter.com/1/accounts/hkk5/line_items/6zva')).to have_been_made
    end
  end

  describe '#destroy_line_item' do
    before do
      stub_delete('https://ads-api.twitter.com/1/accounts/43853bhii879/line_items/43852jv8hlcjA')
    ...
    it 'deletes the correct resource' do
      ...
      expect(a_delete('https://ads-api.twitter.com/1/accounts/43853bhii879/line_items/43852jv8hlcjA')).to have_been_made
    end
  end
end
