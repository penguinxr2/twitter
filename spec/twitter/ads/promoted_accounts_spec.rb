...
describe Twitter::Ads::PromotedAccounts do
  ...
  describe '#promoted_accounts' do
    before do
      stub_get('https://ads-api.twitter.com/1/accounts/hkk5/promoted_accounts').to_return(body: fixture('promoted_accounts.json'), headers:{content_type: 'application/json; charset=utf-8'})
    end
    it 'requests resources' do
      @client.promoted_accounts('hkk5')
      expect(a_get('https://ads-api.twitter.com/1/accounts/hkk5/promoted_accounts')).to have_been_made
    end
  ...
  describe '#promote_account' do
    ...
    before do
      stub_post('https://ads-api.twitter.com/1/accounts/43853bhii879/promoted_accounts').with(body: expected)
    ...
    it 'creates a campgin' do
      ...
      expect(a_post('https://ads-api.twitter.com/1/accounts/43853bhii879/promoted_accounts')).to have_been_made
